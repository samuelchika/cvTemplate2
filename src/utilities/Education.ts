...
import { EducationTemplate } from './Interfaces.js';

export class Education {
    constructor(private edu:EducationTemplate) {}

    public getEducation(): HTMLElement {
        ...
        const course = new ElementCreate('H3');
        ...
        learningOutcomes.setClasses(['ml-3', 'w-75']);
